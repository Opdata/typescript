...
var Chart = require("chart.js"); // @types/chart.js
// utils
function $(selector) {
...
(function (CovidStatus) {
    ...
    CovidStatus["Recovered"] = "recovred";
...
function renderChart(data, labels) {
    // ctx 코드의 getContext 속성이 없다고 떳었는데, 이는 2가지 방식으로 해결이 가능하다.
    /* 해결법 1
    ...
    */
    var ctx = $('#lineChart').getContext('2d'); // 해결법 1 사용
    if (!ctx) {
        return;
    }
